...
class PainelEquipe extends JPanel {
    ...
    PainelEquipe(JanelaPrincipal janela) {
        ...
        Estilo.aplicarBotao(salvar, Estilo.GOLD);
        salvar.addActionListener(e -> {
            janela.salvarJogoAtual();
            JOptionPane.showMessageDialog(this, "Jogo salvo com sucesso!", "Monster Realm",
    ...
    private JPanel cartao(Monstro m) {
        ...
        JPanel sp = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                MonstroSprite.desenharPixelado((Graphics2D) g, m.getNome(), m.getTipo(), m.getEstagio(), getWidth() / 2, getHeight() / 2, 105, !m.estaVivo());
            }
        };
        sp.setOpaque(false);
